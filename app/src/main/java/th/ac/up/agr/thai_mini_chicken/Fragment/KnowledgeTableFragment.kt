...
class KnowledgeTableFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (ID.contentEquals("0")) {
            ...
            data.apply {
                add(TableData("ข่า", "มีผลต่อสมรรถนะการผลิต คุณภาพซาก และการควบคุมโรคบิด", "", R.drawable.h1))
                add(TableData("ขมิ้นชัน", "สารเสริมที่ส่งผลทางประสาทสัมผัสของเนื้อไก่ มีผลต่อสมรรถนะการเจริญเติบโต คุณภาพซากและการตอบสนองของภูมิคุ้มกันโรค", "", R.drawable.h2))
                add(TableData("พโหม", "มีผลต่อภาวะความเครียด และระดับภูมิคุ้มกันโรค", "", R.drawable.h3))
                add(TableData("กระเทียม และออริกาโน", "มีผลต่อสมรรถนะการเจริญเติบโต ซาก อวัยวะและลักษณะเลือด และจุลินทรีย์ในลำไส้", "", R.drawable.h4))
                add(TableData("สะเดา", "มีผลต่อน้ำหนักตัวสูงขึ้น ประสิทธิภาพการเปลี่ยนเป็นน้ำหนัก", "", R.drawable.h5))
                add(TableData("พริกขี้หนู", "มีผลต่อการเจริญเติบโต การย่อยได้บริเวณลำไส้เล็กส่วนปลาย และการเกิดลิปิดเปอร์ ออกซิเดชั่น ภายใต้สภาวะการเลี้ยงที่หนาแน่น", "", R.drawable.h6))
                add(TableData("กล้วยดิบ", "มีผลต่อสมรรถนะการผลิต คุณภาพซาก และการควบคุมโรคในไก่", "", R.drawable.h7))
                add(TableData("บอระเพ็ด", "มีผลต่อสมรรถนะการผลิต ลดอัตราการตาย มีภูมิคุ้มกันต่อโรคนิวคาสเซิล และกัมโบโร", "", R.drawable.h8))
                add(TableData("ไพล", "มีผลต่อน้ำหนักตัวสูงขึ้น ประสิทธิภาพการเปลี่ยนเป็นน้ำหนัก", "", R.drawable.h9))
                add(TableData("ฟ้าทะลายโจร", "มีผลต่อน้ำหนักตัวสูงขึ้น ประสิทธิภาพการเปลี่ยนเป็นน้ำหนัก", "", R.drawable.h10))
                add(TableData("ใบบัวบก", "มีผลต่อคุณลักษณะการเจริญเติบโต ปริมาณเอนไซม์จากเซลล์เยื่อบุผนังลำไส้เล็ก และ การย่อยได้ของโภชนะ", "", R.drawable.h11))
